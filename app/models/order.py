...
class Order(UUIDMixin, TimestampMixin, Base):
    ...
    status = Column(SAEnum(OrderStatus, native_enum=False), default=OrderStatus.PENDING, nullable=False, index=True)
    source = Column(SAEnum(OrderSource, native_enum=False), default=OrderSource.SALESPERSON, nullable=False)
