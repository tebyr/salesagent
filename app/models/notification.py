...
class NotificationSchedule(UUIDMixin, TimestampMixin, Base):
    ...
    event_type = Column(SAEnum(NotificationEventType, native_enum=False), nullable=False)
...
class NotificationLog(UUIDMixin, Base):
    ...
    event_type = Column(SAEnum(NotificationEventType, native_enum=False), nullable=False, index=True)
